...
png("~/Documents/Studium/WU MBA/Harvard_Ted_Kwartler/Harvard_DataScience_class/characterTally_plot.png")
barplot(characterTally[1:10], main='Force Awakens: Character Scene Tally')
dev.off()
...
ggsave("~/Documents/Studium/WU MBA/Harvard_Ted_Kwartler/Harvard_DataScience_class/character_scenes.pdf")
ggsave("~/Documents/Studium/WU MBA/Harvard_Ted_Kwartler/Harvard_DataScience_class/character_scenes.png")
ggsave("~/Documents/Studium/WU MBA/Harvard_Ted_Kwartler/Harvard_DataScience_class/character_scenes.jpg")
